        ...
        if (handler is HandlerMethod) {
            domainProvider.findInMvcCall(handler)?.also { domain ->
                ...
                if (domainValue != null) {
                    ...
                    io.github.feddena.monolith.splitter.DomainHandlerInterceptor.Companion.log.warn(
            ...
            io.github.feddena.monolith.splitter.DomainHandlerInterceptor.Companion.log.warn(
                "Failed to enrich domain tag - handler=${handler.javaClass}",
            )
        }
    }

    private companion object {
        val log: Logger = LoggerFactory.getLogger(io.github.feddena.monolith.splitter.DomainHandlerInterceptor::class.java)
    }
}
